...
export const getStreakStatusMessage = ({
  ...
  if (currentStreak === 0) {
    return "¡Empieza tu racha de escritura hoy mismo! ✨";
  }
  ...
  const messages = {
    // TRADUCCIONES AQUÍ
    1: hasEntryToday
      ? "¡Gran comienzo! ¡Sigue así mañana! 🔥"
      : "Racha de 1 día: ¡escribe hoy para continuar! 💪",
    default: hasEntryToday
      ? `¡Increíble! ¡Racha de ${currentStreak} días! 🔥`
      : `Racha de ${currentStreak} días: ¡escribe hoy para continuar! 🔥`,
  };
