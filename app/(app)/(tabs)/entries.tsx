...
export default function EntriesScreen() {
  ...
  const groupEntriesByDate = (
    ...
    return entries.reduce((groups: GroupedEntries, entry) => {
      ...
      // CAMBIO: Usamos métodos locales (sin UTC) para respetar tu zona horaria (Perú)
  ...
  if (loading) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.loadingText}>Cargando tus notas del diario...</Text>
      </View>
    );
  }
  ...
  if (entries.length === 0) {
    return (
      <View style={styles.centerContainer}>
        <Text style={styles.emptyTitle}>Aún no tienes notas en tu diario</Text>
        <Text style={styles.emptySubtitle}>
          Toca el botón + para escribir tu primera nota del diario.
        </Text>
        <CreateEntryButton />
      </View>
    );
