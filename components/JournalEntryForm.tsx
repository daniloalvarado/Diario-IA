...
export default function JournalEntryForm({
  ...
  const handleSave = async () => {
    ...
    if (!mood) {
      Alert.alert("Estado de ánimo faltante", "Por favor selecciona cómo te sientes.");
      return;
    }
  ...
  const showImageOptions = () => {
    Alert.alert("Agregar Imagen", "Elige cómo quieres agregar una imagen", [
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.toolbar}>
        ...
        <View style={[styles.toolbarRight, {gap: 0}]}>
          <TouchableOpacity
            disabled={isSaving}
